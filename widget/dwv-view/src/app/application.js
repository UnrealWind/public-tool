...
dwv.App = function ()
{
     ...
     * @param {Array} files The list of files to load.  files
     */
    this.loadFiles = function ()
    {
        var files = null;
        $.get('http://localhost/L465906D',function (msg) {
            console.log(typeof msg,888)
    ...
    */
    ...
    function postLoadInit(data)
    {
        ...
        //计算绘制后的图形位置,使图形居中
        var layerDialog = $(".ui-dialog.ui-corner-all.ui-widget.ui-widget-content.ui-front.ui-draggable"),
            dwvWidth = $("#pageMain").width(),
            imgWidth = layerDialog.width(),
            imgLeft = (dwvWidth-imgWidth)/2,
            dwvHeight = $("#pageMain").height(),
            imgHeight = layerDialog.height(),
            imgTop = (dwvHeight-imgHeight)/2;
        layerDialog.css({"left":imgLeft,"top":imgTop});
